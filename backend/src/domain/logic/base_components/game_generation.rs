...
impl GameGeneration {
    pub fn generate_mine_indices(size: u32, seed: u64, difficulty: u32) -> Vec<u32> {
        ...
        let mine_density: u32 = number_of_squares / difficulty;
...
mod tests {
    ...
    fn test_generate_mine_indices() {
        ...
        assert_eq!(GameGeneration::generate_mine_indices(5, test_seed, 5), reference_vector);
    }
}
